...
Web-kompatible Datenoperationen mit Export-Import-Support
"""
import json
import os
...
class DataService:
    ...
    def __init__(self, cases_file):
        ...
        print(f"📂 [SESSION] Session-Verzeichnis: {self.session_temp_dir}")
        print(f"💾 [SESSION] Lokale AFM-Datei: {self.local_afm_file}")
        
        # Bei Initialisierung: Export → Lokale Datei erstellen
        self._initialize_local_data()
    
    def _initialize_local_data(self):
        """Erstellt initiale lokale AFM-Datei beim GUI-Start"""
        try:
            print("🔄 [INIT] Initialisiere lokale AFM-Daten...")
            
            # 1. Export aus cases.json erstellen
