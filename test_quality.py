...
Punkt 2: Fehlende Verlinkungen (auskommentiert)
Punkt 3: Workflow-Überprüfung (auskommentiert)
Punkt 4: Kompatibilität für Internetanwendung (auskommentiert)
"""
...
# ----------- Punkt 3: Workflow überprüfen (auskommentiert) -----------
